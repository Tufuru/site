<?php
    ...
    if (!empty($myrow['ID'])) {
        exit ("Введенный вами логин уже зарегестрирован. Введите другой логин.");
    }

    $result2 = $mysqli->query ("INSERT INTO users (Name, Login, Pass) VALUES('$name', '$login', '$pass')");

    if ($result2 == 'TRUE') {
        echo "Вы успешно теперь вы можете зайти на сайт под своим именем. <a href = 'index.php'>Главная страница</a>";
    }
    else {
